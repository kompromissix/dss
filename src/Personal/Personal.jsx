...
import mashina from '../assetsPersonal/Rectangle44.png'


function Onetofive(sa) {
    return(
        <div className='Onetofive-block'>
            <div className='Onetofive-top'>
                {sa.number}
            </div>
            <div className='Onetofive-bottom'>
                <p>{sa.text}</p>
            </div>
        </div>
    ) 
                        ...
                        <div className='text-menu'>
                            <div className='block-top'>
                                <div>
                                    ...
                                    <div className='block-bottom-makaroni'>
                                        <div className='block-bottom-makaroni-verh'>
                                            <Onetofive {...noways[0]}/> 
                                            <Onetofive {...noways[1]}/> 
                                            <Onetofive {...noways[2]}/> 
                                        </div>
                                        <div className='block-bottom-makaroni-niz'> 
                                            <Onetofive {...noways[3]}/> 
                                            <Onetofive {...noways[4]}/> 
                                        </div>
                                    </div>
